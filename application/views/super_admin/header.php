      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/images/user/avatar.png')?>" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Super_admin/users');?>"><i class="fa fa-circle-o"></i> Master Users</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

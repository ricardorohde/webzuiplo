    ...
    <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body pad">
                  <form method="POST" action="<?php echo base_url("Super_admin/save_master_faqandhelp");?>">
            ...
            <tbody>
              ...
              foreach ($master_faqhelp as $key) {
                ...
                <tr class="even pointer">
                      ...
                      <td><?php echo $key['id'];
                  ?></td>
                  <td><?php echo $key['judul'];
                  ?></td>
                      <td><?php echo $key['isi'];
                  ?></td>

<td><a href="<?php echo base_url('Super_admin/delete_master_faqandhelp/'.$key['id']);
                  ?>" onClick="return doconfirm();">
                    ...
                    <a href="<?php echo base_url('Super_admin/edit_master_faqandhelp/'.$key['id']);

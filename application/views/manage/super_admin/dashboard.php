...
<link href="<?php echo base_url('assets/super_admin/libraries/owl.carousel/assets/owl.carousel.css');?>" rel="stylesheet" type="text/css" >
<link href="<?php echo base_url('assets/super_admin/libraries/colorbox/example1/colorbox.css');?>" rel="stylesheet" type="text/css" >
<link href="<?php echo base_url('assets/super_admin/libraries/bootstrap-select/bootstrap-select.min.css');?>" rel="stylesheet" type="text/css">
<link href="<?php echo base_url('assets/super_admin/libraries/bootstrap-fileinput/fileinput.min.css');?>" rel="stylesheet" type="text/css">
<link href="<?php echo base_url('assets/super_admin/css/superlist.css');?>" rel="stylesheet" type="text/css" >

<link rel="shortcut icon" type="image/x-icon" href="assets/favicon.png');?>">

<title>Superlist - Admin Forms</title>
    ...
    <div class="container-fluid">
        <div class="header-inner">
            <div class="header-logo">
                <a href="index.html">
                    <img src="<?php echo base_url('assets/super_admin/img/logo.png');?>" alt="Logo">
                </a>
            </div><!-- /.header-logo -->
...
<div class="dropdown">
    <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
        <div class="user-image">
            <img src="<?php echo base_url('assets/super_admin/img/tmp/agent-2.jpg');?>">
...
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/collapse.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/carousel.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/transition.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/dropdown.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/tooltip.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/tab.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-sass/javascripts/bootstrap/alert.js');?>" type="text/javascript"></script>

<script src="<?php echo base_url('assets/super_admin/libraries/colorbox/jquery.colorbox-min.js');?>" type="text/javascript"></script>

<script src="<?php echo base_url('assets/super_admin/libraries/flot/jquery.flot.min.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/super_admin/libraries/flot/jquery.flot.spline.js');?>" type="text/javascript"></script>

<script src="<?php echo base_url('assets/super_admin/libraries/bootstrap-select/bootstrap-select.min.js');?>" type="text/javascript"></script>


<script type="text/javascript" src="<?php echo base_url('assets/super_admin/libraries/jquery-google-map/infobox.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/super_admin/libraries/jquery-google-map/markerclusterer.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/super_admin/libraries/jquery-google-map/jquery-google-map.js');?>"></script>

<script type="text/javascript" src="<?php echo base_url('assets/super_admin/libraries/owl.carousel/owl.carousel.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/super_admin/libraries/bootstrap-fileinput/fileinput.min.js');?>"></script>

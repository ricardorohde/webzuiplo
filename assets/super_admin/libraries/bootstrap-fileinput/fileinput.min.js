...
! function(e) {
  ...
  var i = function(e) {
      ...
      return t.innerHTML = "<!--[if IE " + e + "]><i></i><![endif]-->", i = 1 === t.getElementsByTagName("i")
        .length, document.body.appendChild(t), t.parentNode.removeChild(t), i
    },
    t = function(e, i, t, a) {
    ...
    a = {
      ...
      count: function(e, i) {
        return a.data[e] && a.data[e].content ? i ? a.data[e].content.length : a.fetch(e)
          .length : 0
      },
      get: function(i, t, n) {
        var r, l, o = "init_" + t,
        ...
        return n = void 0 === n ? !0 : n, null === s.content[t] ? "" : (Z(d) || Z(d.frameClass) || (p += " " + d.frameClass), r = s.template.replace(/\{previewId\}/g, c)
          .replace(/\{frameClass\}/g, p)
          .replace(/\{fileindex\}/g, o)
          .replace(/\{content\}/g, s.content[t])
          .replace(/\{footer\}/g, a.footer(i, t, n)), s.tags.length && s.tags[t] && (r = K(r, s.tags[t])), Z(d) || Z(d.frameAttr) || (l = e(document.createElement("div"))
            .html(r), l.find(".file-preview-initial")
            .attr(d.frameAttr), r = l.html(), l.remove()), r)
      },
    ...
    K = function(i, t) {
      ...
      return t ? (e.each(t, function(e, i) {
        "function" == typeof i && (i = i()), a = a.split(e)
          .join(i)
      }), a) : a
    },
  ...
  J.prototype = {
      ...
      parseFilePreviewIcon: function(i, t) {
        var a, n = this,
          r = n.previewFileIcon;
        return t && t.indexOf(".") > -1 && (a = t.split(".")
            .pop(), n.previewFileIconSettings && n.previewFileIconSettings[a] && (r = n.previewFileIconSettings[a]), n.previewFileExtSettings && e.each(n.previewFileExtSettings, function(e, i) {
              n.previewFileIconSettings[e] && i(a) && (r = n.previewFileIconSettings[e])
            })), i.indexOf("{previewFileIcon}") > -1 ? i.replace(/\{previewFileIconClass\}/g, n.previewFileIconClass)
          .replace(/\{previewFileIcon\}/g, r) : i
      },
      ...
      noFilesError: function(e) {
        var i = this,
          ...
          a = i.msgFilesTooLess.replace("{n}", i.minFileCount)
          .replace("{files}", t),
          n = i.$errorContainer;
      ...
      lock: function() {
        var e = this;
        e.resetErrors(), e.disable(), e.showRemove && s(e.$container.find(".fileinput-remove"), "hide"), e.showCancel && e.$container.find(".fileinput-cancel")
          .removeClass("hide"), e.raise("filelock", [e.filestack, e.getExtraData()])
      },
      unlock: function(e) {
        var i = this;
        void 0 === e && (e = !0), i.enable(), i.showCancel && s(i.$container.find(".fileinput-cancel"), "hide"), i.showRemove && i.$container.find(".fileinput-remove")
          .removeClass("hide"), e && i.resetFileStack(), i.raise("fileunlock", [i.filestack, i.getExtraData()])
      },
      ...
      destroy: function() {
        var e = this,
          i = e.$container;
        i.find(".file-drop-zone")
          .off(), e.$element.insertBefore(i)
          .off(".fileinput")
          .removeData(), i.off()
          .remove()
      },
      ...
      initDragDrop: function() {
        ...
        t(a, "dragenter.fileinput dragover.fileinput", function(t) {
          ...
          t.stopPropagation(), t.preventDefault(), i.isDisabled || e(this)
            .removeClass("highlighted")
        }), t(a, "drop", function(t) {
          t.preventDefault(), i.isDisabled || Z(t.originalEvent.dataTransfer.files) || (i.change(t, "dragdrop"), e(this)
            .removeClass("highlighted"))
      ...
      setFileDropZoneTitle: function() {
        ...
        i.find("." + e.dropZoneTitleClass)
          .remove(), e.isUploadable && e.showPreview && 0 !== i.length && !(e.getFileStack()
            .length > 0) && e.dropZoneEnabled && (0 === i.find(".file-preview-frame")
            .length && i.prepend('<div class="' + e.dropZoneTitleClass + '">' + e.dropZoneTitle + "</div>"), e.$container.removeClass("file-input-new"), s(e.$container, "file-input-ajax-new"))
      },
      initFileActions: function() {
        var i = this;
        i.$preview.find(".kv-file-remove")
          .each(function() {
            var n, r, l = e(this),
      ...
      getMsgSelected: function(e) {
        ...
        return i.msgSelected.replace("{n}", e)
          .replace("{files}", t)
      },
      renderFileFooter: function(e, i) {
        ...
        return n.isUploadable ? (t = l.replace(/\{actions\}/g, n.renderFileActions(!0, !0, !1, !1, !1)), a = t.replace(/\{caption\}/g, e)
            .replace(/\{width\}/g, i)
            .replace(/\{indicator\}/g, r.indicatorNew)
            .replace(/\{indicatorTitle\}/g, r.indicatorNewTitle)) : a = l.replace(/\{actions\}/g, "")
          .replace(/\{caption\}/g, e)
          .replace(/\{width\}/g, i)
          .replace(/\{indicator\}/g, "")
          .replace(/\{indicatorTitle\}/g, ""), a = K(a, n.previewThumbTags)
      },
      renderFileActions: function(e, i, t, a, n) {
        ...
        return s = s.replace(/\{removeClass\}/g, f)
          .replace(/\{removeIcon\}/g, u.removeIcon)
          .replace(/\{removeTitle\}/g, u.removeTitle)
          .replace(/\{dataUrl\}/g, l)
          .replace(/\{dataKey\}/g, o), e && (d = r.getLayoutTemplate("actionUpload")
            .replace(/\{uploadClass\}/g, u.uploadClass)
            .replace(/\{uploadIcon\}/g, u.uploadIcon)
            .replace(/\{uploadTitle\}/g, u.uploadTitle)), c.replace(/\{delete\}/g, s)
          .replace(/\{upload\}/g, d)
          .replace(/\{other\}/g, p)
      },
      ...
      clearPreview: function() {
        ...
        i.remove(), e.$preview.find(".file-preview-frame")
          .length && e.showPreview || e.resetUpload()
      },
      ...
      initPreviewDeletes: function() {
        var i = this,
          n = i.deleteExtraData || {},
          r = function() {
            0 === i.$preview.find(".kv-file-remove")
              .length && (i.reset(), i.initialCaption = "")
          };
        i.$preview.find(".kv-file-remove")
          .each(function() {
            var l = e(this),
            ...
            if (!Z(o) && void 0 !== d) {
              ...
              m = parseInt(m.replace("init_", "")), u = Z(g.config) && Z(g.config[m]) ? null : g.config[m], f = Z(u) || Z(u.extra) ? n : u.extra, "function" == typeof f && (f = f()), p = {
                ...
                success: function(e, t, n) {
                  var o, s;
                  return Z(e) || Z(e.error) ? (a.unset(i.id, m), o = a.count(i.id), s = o > 0 ? i.getMsgSelected(o) : "", i.raise("filedeleted", [d, n, f]), i.setCaption(s), v.removeClass("file-uploading")
                    .addClass("file-deleted"), void v.fadeOut("slow", function() {
                      i.clearObjects(v), v.remove(), r(), o || 0 !== i.getFileStack()
                        .length || (i.setCaption(""), i.reset())
      ...
      clearFileInput: function() {
        var i, t, a, n = this,
          r = n.$element;
        Z(r.val()) || (n.isIE9 || n.isIE10 ? (i = r.closest("form"), t = e(document.createElement("form")), a = e(document.createElement("div")), r.before(a), i.length ? i.after(t) : a.after(t), t.append(r)
          .trigger("reset"), a.before(r)
          .remove(), t.remove()) : r.val(""), n.fileInputCleared = !0)
      },
      ...
      cancel: function() {
        ...
        t.getThumbs()
          .each(function() {
            ...
            i.removeClass("file-uploading"), void 0 !== t.filestack[a] && (i.find(".kv-file-upload")
              .removeClass("disabled")
              .removeAttr("disabled"), i.find(".kv-file-remove")
              .removeClass("disabled")
              .removeAttr("disabled")), t.unlock()
          })
      },
      cleanMemory: function(e) {
        var i = e.is("img") ? e.attr("src") : e.find("source")
          .attr("src");
        X.revokeObjectURL(i)
      },
      ...
      clear: function() {
        var i, t = this;
        t.$btnUpload.removeAttr("disabled"), t.getThumbs()
          .find("video,audio,img")
          .each(function() {
            t.cleanMemory(e(this))
          }), t.resetUpload(), t.filestack = [], t.clearFileInput(), t.resetErrors(!0), t.raise("fileclear"), t.hasInitialPreview() ? (t.showFileIcon(), t.resetPreview(), t.initPreviewDeletes(), t.$container.removeClass("file-input-new")) : (t.getThumbs()
            .each(function() {
              t.clearObjects(e(this))
            }), t.isUploadable && (a.data[t.id] = {}), t.$preview.html(""), i = !t.overwriteInitial && t.initialCaption.length > 0 ? t.initialCaption : "", t.setCaption(i), t.$caption.attr("title", ""), s(t.$container, "file-input-new")), 0 === t.$container.find(".file-preview-frame")
          .length && (t.initCaption() || t.$captionContainer.find(".kv-caption-icon")
            .hide()), t.hideFileIcon(), t.raise("filecleared"), t.$captionContainer.focus(), t.setFileDropZoneTitle()
      },
      ...
      reset: function() {
        var e = this;
        e.resetPreview(), e.$container.find(".fileinput-filename")
          .text(""), e.raise("filereset"), s(e.$container, "file-input-new"), (e.$preview.find(".file-preview-frame")
            .length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"), e.setFileDropZoneTitle(), e.filestack = [], e.formdata = {}
      },
      disable: function() {
        var e = this;
        e.isDisabled = !0, e.raise("filedisabled"), e.$element.attr("disabled", "disabled"), e.$container.find(".kv-fileinput-caption")
          .addClass("file-caption-disabled"), e.$container.find(".btn-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button")
          .attr("disabled", !0), e.initDragDrop()
      },
      enable: function() {
        var e = this;
        e.isDisabled = !1, e.raise("fileenabled"), e.$element.removeAttr("disabled"), e.$container.find(".kv-fileinput-caption")
          .removeClass("file-caption-disabled"), e.$container.find(".btn-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button")
          .removeAttr("disabled"), e.initDragDrop()
      },
          ...
          .each(function() {
            ...
            n.removeAttr("disabled"), t(n, "click", function() {
              ...
              i.cleanMemory(a), e !== !1 && a.fadeOut("slow", function() {
                a.remove(), i.$preview.find(".file-preview-frame")
                  .length || i.reset()
              })
            })
          })
      ...
      uploadBatch: function() {
        ...
        l.formdata = new FormData, 0 !== d && p && !l.abort(c) && (i = function() {
          ...
          Z(t) || Z(t.error) ? (l.raise("filebatchuploadsuccess", [r]), i(), l.showPreview ? (o.each(function() {
            var i = e(this),
              t = i.find(".kv-file-upload");
            i.find(".kv-file-upload")
              .hide(), l.setThumbStatus(i, "Success"), i.removeClass("file-uploading"), t.removeAttr("disabled")
          }), l.initUploadSuccess(t)) : l.reset()) : (l.showPreview && (o.each(function() {
            var i = e(this),
              t = i.find(".kv-file-remove"),
              a = i.find(".kv-file-upload");
            return i.removeClass("file-uploading"), a.removeAttr("disabled"), t.removeAttr("disabled"), 0 === s.length ? void l.setThumbStatus(i, "Error") : (-1 !== e.inArray(d, s) ? l.setThumbStatus(i, "Error") : (i.find(".kv-file-upload")
              .hide(), l.setThumbStatus(i, "Success"), l.filestack[d] = void 0), void d++)
          ...
          var n = l.getOutData(i),
            r = l.parseError(i, a);
          l.showUploadError(r, n, "filebatchuploaderror"), l.uploadFileCount = d - 1, l.showPreview && (l.getThumbs()
            .each(function() {
              var i = e(this),
                t = i.attr("data-fileindex");
              i.removeClass("file-uploading"), void 0 !== l.filestack[t] && l.setThumbStatus(i, "Error")
            }), l.getThumbs()
            .removeClass("file-uploading"), l.getThumbs(" .kv-file-upload")
            .removeAttr("disabled"), l.getThumbs(" .kv-file-delete")
            .removeAttr("disabled"))
      ...
      hideFileIcon: function() {
        this.overwriteInitial && this.$captionContainer.find(".kv-caption-icon")
          .hide()
      },
      showFileIcon: function() {
        this.$captionContainer.find(".kv-caption-icon")
          .show()
      },
      ...
      showUploadError: function(e, i, t) {
        var a = this,
          ...
          r = t || "fileuploaderror";
        return 0 === n.find("ul")
          .length ? n.html("<ul><li>" + e + "</li></ul>") : n.find("ul")
          .append("<li>" + e + "</li>"), n.fadeIn(800), a.raise(r, [i]), a.$container.removeClass("file-input-new"), s(a.$container, "has-error"), !0
      },
      ...
      parseFileType: function(e) {
        ...
        for (n = 0; n < M.length; n += 1)
          if (a = M[n], i = W(a, r.fileTypeSettings) ? r.fileTypeSettings[a] : N[a], t = i(e.type, e.name) ? a : "", !Z(t)) return t;
        return "other"
      },
      previewDefault: function(i, t, a) {
        if (this.showPreview) {
          ...
          a === !0 && (l = " btn disabled", n.isUploadable || (d += '<div class="file-other-error" title="' + n.fileActionSettings.indicatorErrorTitle + '">' + n.fileActionSettings.indicatorError + "</div>")), n.$preview.append("\n" + p.replace(/\{previewId\}/g, t)
            ...
            .replace(/\{data\}/g, r)
            .replace(/\{footer\}/g, d)), a === !0 && n.isUploadable && n.setThumbStatus(e("#" + t), "Error")
        }
      },
      previewFile: function(e, i, t, a, n) {
        if (this.showPreview) {
          ...
          g || h ? (v = s.parseFilePreviewIcon(v, c.split(".")
              .pop()), "text" === d ? (l = V(t.target.result), o = "text-" + q(), r = v.replace(/\{zoom\}/g, s.getLayoutTemplate("zoom")), b = s.getLayoutTemplate("modal")
              .replace("{id}", o)
              .replace(/\{title\}/g, p)
              .replace(/\{body\}/g, l)
              .replace(/\{heading\}/g, s.msgZoomModalHeading), r = r.replace(/\{previewId\}/g, a)
              .replace(/\{caption\}/g, p)
              ...
              .replace(/\{data\}/g, l) + b) : r = v.replace(/\{previewId\}/g, a)
            .replace(/\{caption\}/g, p)
            .replace(/\{frameClass\}/g, "")
            .replace(/\{type\}/g, i.type)
            .replace(/\{fileindex\}/g, C)
      ...
      readFiles: function(i) {
        function t(e) {
          ...
          var m, h, w, b, C, x, y = v + e,
            ...
            j = Z(U) ? "" : U.join(", ");
          if (Z(U) || ($ = new RegExp("\\.(" + U.join("|") + ")$", "i")), k = k.toFixed(2), a.maxFileSize > 0 && k > a.maxFileSize) return b = a.msgSizeTooLarge.replace("{name}", E)
            .replace("{size}", k)
            .replace("{maxSize}", a.maxFileSize), void(a.isError = g(b, F, T, e));
          if (!Z(P) && H(P)) {
            for (w = 0; w < P.length; w += 1) C = P[w], h = f[C], x = void 0 !== h && h(F.type, E), S += Z(x) ? 0 : x.length;
            if (0 === S) return b = a.msgInvalidFileType.replace("{name}", E)
              .replace("{types}", D), void(a.isError = g(b, F, T, e))
          }
          return 0 !== S || Z(U) || !H(U) || Z($) || (x = E.match($), S += Z(x) ? 0 : x.length, 0 !== S) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.replace("{index}", e + 1)
            .replace("{files}", u)), o.addClass("loading"), l.onerror = function(e) {
            a.errorHandler(e, E)
          }, l.onload = function(i) {
            a.previewFile(e, F, i, T, I), a.initFileActions()
          }, l.onloadend = function() {
            b = c.replace("{index}", e + 1)
              .replace("{files}", u)
              .replace("{percent}", 50)
              .replace("{name}", E), setTimeout(function() {
          ...
          }, 100), a.raise("fileloaded", [F, T, e, l])), void a.filestack.push(F)) : (a.filestack.push(F), setTimeout(t(e + 1), 100), void a.raise("fileloaded", [F, T, e, l])) : (b = a.msgInvalidFileExtension.replace("{name}", E)
            .replace("{extensions}", j), void(a.isError = g(b, F, T, e)))
        }
      ...
      updateFileDetails: function(e) {
        ...
        i.isError ? (i.$previewContainer.removeClass("loading"), i.$previewStatus.html(""), i.$captionContainer.find(".kv-caption-icon")
          .hide()) : i.showFileIcon(), i.setCaption(d, i.isError), i.$container.removeClass("file-input-new file-input-ajax-new"), 1 === arguments.length && i.raise("fileselect", [e, l]), a.count(i.id) && i.initPreviewDeletes()
      },
      validateMinCount: function() {
        var e = this,
          i = e.isUploadable ? e.getFileStack()
          .length : e.$element.get(0)
          .files.length;
      ...
      change: function(i) {
        ...
        var r, l, o, s, d, c, p = arguments.length > 1,
          u = p ? i.originalEvent.dataTransfer.files : n.get(0)
          .files,
          f = Z(n.attr("multiple")),
          v = 0,
          g = 0,
        ...
        if (t.reader = null, t.resetUpload(), t.hideFileIcon(), t.isUploadable && t.$container.find(".file-drop-zone ." + t.dropZoneTitleClass)
          .remove(), p)
          for (r = []; u[v];) s = u[v], s.type || s.size % 4096 !== 0 ? r.push(s) : g++, v++;
        ...
        if (t.resetErrors(), c = r.length, o = t.isUploadable ? t.getFileStack()
          .length + c : c, o = t.getFileCount(o), t.maxFileCount > 0 && o > t.maxFileCount) {
          if (!t.autoReplace || c > t.maxFileCount) return d = t.autoReplace && c > t.maxFileCount ? c : o, l = t.msgFilesTooMany.replace("{m}", t.maxFileCount)
            .replace("{n}", d), t.isError = b(l, null, null, null), t.$captionContainer.find(".kv-caption-icon")
            .hide(), t.setCaption("", !0), void t.$container.removeClass("file-input-new file-input-ajax-new");
      ...
      checkDimensions: function(e, i, t, a, n, r, l) {
        var o, s, d, c, p = this,
          u = "Small" === i ? "min" : "max",
          f = p[u + "Image" + r];
        !Z(f) && t.length && (d = t[0], s = "Width" === r ? d.naturalWidth || d.width : d.naturalHeight || d.height, c = "Small" === i ? s >= f : f >= s, c || (o = p["msgImage" + r + i].replace("{name}", n)
          .replace("{size}", f), p.showUploadError(o, l), p.setThumbStatus(a, "Error"), p.filestack[e] = null))
      },
      ...
      setCaption: function(i, t) {
        var a, n, r = this;
        if (t) a = e("<div>" + r.msgValidationError + "</div>")
          .text(), n = '<span class="' + r.msgValidationErrorClass + '">' + r.msgValidationErrorIcon + a + "</span>";
        else {
          if (Z(i) || 0 === r.$caption.length) return;
          a = e("<div>" + i + "</div>")
            .text(), n = r.getLayoutTemplate("icon") + a
        }
        r.$caption.html(n), r.$caption.attr("title", a), r.$captionContainer.find(".file-caption-ellipsis")
          .attr("title", a)
      },
      ...
      renderMain: function() {
        var e = this,
          ...
          t = e.showPreview ? e.getLayoutTemplate("preview")
        ...
        return e.mainTemplate.replace(/\{class\}/g, e.mainClass)
          .replace(/\{preview\}/g, t)
          .replace(/\{caption\}/g, n)
      ...
      renderButton: function(e) {
        ...
        switch (e) {
          ...
          case "upload":
            ...
            i.isUploadable && !i.isDisabled ? t = i.getLayoutTemplate("btnLink")
              .replace("{href}", i.uploadUrl) : s = "submit";
            break;
          case "browse":
        ...
        return a += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.replace("{type}", s)
          .replace("{css}", a)
          .replace("{title}", n)
          .replace("{status}", o)
          .replace("{icon}", r)
    ...
    }, e.extend(e.fn.fileinput.defaults, e.fn.fileinputLocales.en), e.fn.fileinput.Constructor = J, e(document)
    .ready(function() {
